...
VALUES
  ...
  ('restaurant_commission_percentage', '15', 'number', 'نسبة العمولة من المطاعم (%)'),
  ...
  ('restaurant_document_verification_required', 'true', 'boolean', 'المستندات المطلوبة للمطعم'),
...
VALUES
  ...
  (
    ...
    'Delivery charges depend on your location and the distance. You can see the exact charges before confirming your order.',
    'delivery',
    2,
    true
  ),
