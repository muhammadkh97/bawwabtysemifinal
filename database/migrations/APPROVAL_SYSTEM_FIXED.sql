...
COMMENT ON COLUMN categories.approved_by IS 'معرف المدير الذي وافق أو رفض';
...
COMMENT ON COLUMN categories.created_by IS 'معرف المستخدم الذي أنشأ التصنيف';

-- ✅ تم بنجاح!
-- الآن نظام الموافقات جاهز للاستخدام
