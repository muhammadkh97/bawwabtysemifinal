-- ============================================================================
-- إضافة أسعار صرف عكسية (من جميع العملات إلى USD)
-- ============================================================================

-- إضافة أسعار صرف عكسية لجميع العملات
-- الصيغة: إذا كان USD → X = rate، فإن X → USD = 1/rate
...
-- اختبار التحويل من SAR إلى ILS (عبر USD)
-- SAR → USD → ILS
SELECT 
