...
export default function VendorMessagesPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 transition-colors duration-300">
