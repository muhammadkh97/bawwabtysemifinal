...
export default function RestaurantStaffPage() {
  ...
  const availablePermissions = [
    ...
    { id: 'view_analytics', name: 'عرض التحليلات', description: 'مشاهدة إحصائيات وتقارير المطعم' },
    { id: 'manage_marketing', name: 'إدارة التسويق', description: 'إنشاء الكوبونات والعروض الترويجية' },
    { id: 'manage_settings', name: 'إدارة الإعدادات', description: 'تعديل معلومات المطعم والإعدادات العامة' },
  ];
  ...
  const fetchData = async () => {
    try {
      ...
      if (!restaurantData) {
        toast.error('لم يتم العثور على مطعمك');
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#0A0515] transition-colors duration-300">
      ...
      <div className="md:mr-[280px] transition-all duration-300">
        <FuturisticNavbar userName={(user as any)?.full_name || 'مطعم'} userRole="مطعم" />
        ...
        <main className="pt-24 px-4 md:px-8 lg:px-10 pb-10 relative z-10 max-w-[1800px] mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-purple-300 text-lg">إدارة طاقم عمل مطعمك وتحديد صلاحياتهم</p>
            </div>
            <button
              ...
              <div className="grid grid-cols-1 gap-6">
                {loading ? (
                  ...
                  <div className="text-center py-20 rounded-2xl bg-[#0A0515]/5 border border-purple-500/20">
                    ...
                    <p className="text-purple-300">ابدأ بإضافة أول مساعد لمطعمك</p>
                  </div>
                ) : (
