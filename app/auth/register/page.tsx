...
function RegisterForm() {
  ...
  const userTypeOptions = [
    ...
    },
    {
      ...
      icon: Store,
      title: 'بائع',
      description: 'ابدأ متجرك الإلكتروني',
    ...
    },
    {
      ...
      icon: ChefHat,
      title: 'مطعم',
      description: 'قدم وجباتك للعملاء',
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-purple-300">انضم إلى منصة بوابتي الآن</p>
          </div>
            ...
            {[1, 2].map((s) => (
              <div
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  s === step ? 'w-12 bg-gradient-to-r from-[#6236FF] to-[#FF219D]' : 'w-8 bg-purple-800'
                }`}
              />
            ))}
          </div>
